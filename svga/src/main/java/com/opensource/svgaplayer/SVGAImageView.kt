...
open class SVGAImageView @JvmOverloads constructor(
    ...
    private fun setupDrawable() {
        ...
        showLog("Svga--setup,setupDrawable()")
    }
    ...
    private fun generateScale(): Double {
        ...
        try {
            ...
            val getMethod = animatorClass.getDeclaredMethod("getDurationScale")
    ...
    private fun onAnimationEnd(animation: Animator?) {
        ...
        if (drawable != null) {
            when (fillMode) {
                ...
                FillMode.Clear -> {
                    showLog("Svga--clear,FillMode.Clear")
    ...
    fun pauseAnimation() {
        stopAnimation(false)
        showLog("Svga--pauseAnimation,pauseAnimation()")
        callback?.onPause()
    }
    ...
    fun stopAnimation() {
        ...
        showLog("Svga--clear,stopAnimation() $clearsAfterStop")
    }
    ...
    fun stopAnimation(clear: Boolean) {
        ...
        showLog("Svga--clear,stopAnimation($clear)")
    }
    ...
    fun setVideoItem(videoItem: SVGAVideoEntity?, dynamicItem: SVGADynamicEntity?) {
        if (videoItem == null) {
            ...
            showLog("Svga--clear,setVideoItem()")
        }
    }
...
//        if (context::class.java.simpleName == "HouseAct")
//            Logger.e(text)
    }
